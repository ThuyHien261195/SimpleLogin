...
public class WelcomeActivity extends AppCompatActivity {
    ...
    public void initViews() {
        textViewInfoApp.setText(createSpannableTextInfoApp());
    }

    private SpannableString createSpannableTextInfoApp() {
        ...
        termsText.setSpan(new ForegroundColorSpan(
                        ContextCompat.getColor(this, android.R.color.white)), 0,
                termsText.length(),
                Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);

        SpannableString privacyPolicyText = new SpannableString(
                getText(R.string.title_privacy_policy));
        privacyPolicyText.setSpan(new URLSpan(""), 0,
        ...
        CharSequence infoText = TextUtils.concat(termsText,
                getText(R.string.title_plus),
                privacyPolicyText);
